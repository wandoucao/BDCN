...
def resize_img():
	...
	args.src_color = r'E:/Github/Dataset_original/face_real/train_set/face_color_thin/'
	args.src_label = r'E:/Github/Dataset_original/face_real/train_set/face_label_thin/'

	args.dst_color = r'E:\\Github\\Dataset\\face_real\\train_set\\face_color_thin/'
	args.dst_label = r'E:\\Github\\Dataset\\face_real\\train_set\\face_label_thin/'
	args.augment = 1
	args.resize = 512
	g_bMirror = 1
	g_lBright = 1
	...
	print("color={}; label={}; dst_color={};  dst_label={}; ".format(args.src_color,  args.src_label, args.dst_color, args.dst_label))
	...
	for in_idx, in_ in enumerate(img_list):
		...
		#resize color
		out_color = (in_color.resize((dstHeight,dstWidth)))	
		...
		out_label = (in_label.resize((dstHeight,dstWidth)))	
